...
|---|---|---|---|---|
| A | @ | 216.150.1.1 | Auto/300s | Required: Make manmohit-portfolio.com direct to the site |
| CNAME | www | 097a78404ad594a3.vercel-dns-016.com. | Auto/300s | Optional: Make www.manmohit-portfolio.com also accessible |
...
3. Add records one by one according to the table:
   ...
   - Host Record(Name):
     - Top-level Domain(such as manmohit-portfolio.com) use "@"(some suppliers leave empty to represent @).
     - Subdomain(such as manmohit-portfolio.com) use prefix "@".
...
- **Subdomain Access**: If the subdomain (such as blog.manmohit-portfolio.com) is accessed, usually only the CNAME record in the table needs to be added.
